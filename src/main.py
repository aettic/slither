...
def printTitle():
    print('\n')
    print('   db     888888  888888  88""Yb  Yb  dY  88b 88   dP"Yb   .dP"Y8')
    print('  dPYb    88__      88    88__dP   YbdY   88Yb88  dY   Yb  `Ybo. ')
    print(' dP__Yb   88""      88    88"Yb     88    88 Y88  Yb   dY    `Y8b')
    print('dP""""Yb  888888    88    88  Yb    88    88  Y8   YbodP   `8bodP')
    print('\n')
